...
$query="insert into books values(null,'$_POST[book_name]','$_POST[author_name]','$_POST[category_name]',$_POST[book_no],$_POST[book_price])";
$query_run = mysqli_query($connection,$query);
$query="delete from category where cat_name='$_POST[category_name]'";
$query_run = mysqli_query($connection,$query);
$query="insert into category values(null,'$_POST[category_name]')";
$query_run = mysqli_query($connection,$query);
$query="delete from authors where author_name='$_POST[author_name]'";
$query_run = mysqli_query($connection,$query);
