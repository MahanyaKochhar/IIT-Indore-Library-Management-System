...
<a href="regbooks.php" class="btn btn-primary" target="_blank">View Available Books</a>
</div>
</div>
</div>
<div class="col-md-3">
...
<div class="card-body">
<p class="card-text">No of available categories : <?php echo get_category_count(); ?> </p>
<a href="regcat.php" class="btn btn-secondary" target="_blank">View Available Categories</a>
</div>
</div>
</div>
<div class="col-md-3">
