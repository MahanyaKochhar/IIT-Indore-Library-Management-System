...
<input type="text" name="book_date" class="form-control" value=" <?php echo date("y-m-d");?>" required>
</div>
...
{
if($row['book_no']==$_POST[book_no])
{
$query="insert into issues values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[book_date]','$_POST[cat_name]',$_POST[book_price])";
$query_run = mysqli_query($connection,$query);
$query="delete from books where book_no=$_POST[book_no]";
$query_run = mysqli_query($connection,$query);
